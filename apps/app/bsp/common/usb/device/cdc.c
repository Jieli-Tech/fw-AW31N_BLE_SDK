...
static const u8 uac_audio_interface_association[] = {
    ...
    0,
#endif
    1,//USB_CLASS_AUDIO,//AUDIO_FUNCTION Function Class code
    2,///USB_SUBCLASS_AUDIOSTREAMING,//FUNCTION_SUBCLASS_UNDEFINED
...
u32 audio_asso_desc_config(const usb_dev usb_id, u8 *ptr, u32 *itf)
{
    u8 *tptr;
    tptr = ptr;
    memcpy(tptr, uac_audio_interface_association, sizeof(uac_audio_interface_association));
