#ifndef CONFIG_BOARD_AW31A_RC_H
#define CONFIG_BOARD_AW31A_RC_H

#include "board_aw312a_rc_global_build_cfg.h"

#ifdef CONFIG_BOARD_AW31A_RC
// 遥控器板级，默认开启单脚起振，DP引脚打印，采用矩阵按键
...
//                                  LED 配置                                       //
//*********************************************************************************//
#define TCFG_LED_ENABLE                  ENABLE_THIS_MOUDLE          //LED推灯模块
#define TCFG_LED_PIN1                    IO_PORTA_03                //LED1使用的IO口
// #define TCFG_PWMLED_PIN2                    IO_PORTA_10                //LED2使用的IO口
...
#define TCFG_CLOCK_OSC_1PIN_EN             1//1:晶振单脚模式,0:双脚模式
