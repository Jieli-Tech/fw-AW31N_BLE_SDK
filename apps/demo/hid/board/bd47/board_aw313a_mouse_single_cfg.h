#ifndef CONFIG_BOARD_AW313A_SINGLE_MOUSE_H
#define CONFIG_BOARD_AW313A_SINGLE_MOUSE_H

#include "board_aw313a_mouse_single_global_build_cfg.h"

#ifdef CONFIG_BOARD_AW313A_MOUSE_SINGLE
...
#define TCFG_HAL3212_EN                           DISABLE
