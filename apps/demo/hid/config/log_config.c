...
const char log_tag_const_v_HID_RC AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_i_HID_RC AT(.LOG_TAG_CONST) = 1;
const char log_tag_const_d_HID_RC AT(.LOG_TAG_CONST) = 1;
const char log_tag_const_w_HID_RC AT(.LOG_TAG_CONST) = 1;
const char log_tag_const_e_HID_RC AT(.LOG_TAG_CONST) = 1;
...
const char log_tag_const_i_FAT AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(0);
const char log_tag_const_d_FAT AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(0);
