#ifndef CONFIG_BOARD_AW31N_DEMO_H
#define CONFIG_BOARD_AW31N_DEMO_H

#include "board_aw31n_demo_global_build_cfg.h"
...
#define COMMON_UART_TX_PIN                  IO_PORTA_06                            //串口发送脚配置
#define COMMON_UART_RX_PIN                  IO_PORTA_06                            //串口接收脚配置
#define COMMON_UART_INDEX                   UART_NUM_1
#define TCFG_COMMON_UART_BAUDRATE  	        115200                                //串口波特率配置
