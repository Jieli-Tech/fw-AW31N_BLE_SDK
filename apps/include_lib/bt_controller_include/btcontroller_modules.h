...
AW31N,chip_version A: range(0~5) {-5.0,   -2.2,   +0.1,  +4.2,  +7.0,  +10.0}
AW31N,chip_version B: range(0~5) {-11.8,  -5.8,   -2.4,  +0.1,  +3.2,  +6.0}
*/
...
/* --------------------------------------------------------------------------*/
/**
 * @brief  获取ble支持的最大功率档位
 *
 * @param  null
 * @return 返回ble支持的最大功率档位
 */
/* ----------------------------------------------------------------------------*/
...
bool ble_bb_is_busy(void);
bool check_ble_bb_wakeup_event_hanppened(void);
#endif
