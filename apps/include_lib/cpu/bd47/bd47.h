...
#define JL_CORDIC_BASE                 (hs_base + map_adr(0x07, 0x00))
...
typedef struct {
    __RW __u32 RFLT0_CON;
    __RW __u32 RFLT1_CON;
    __RW __u32 RFLT2_CON;
    __RW __u32 RFLT3_CON;
} JL_IR_TypeDef;
...
#define JL_LEDCK_BASE                   (ls_base + map_adr(0x26,0x00))
...
#define JL_LEDC0_BASE                   (ls_base + map_adr(0x26, 0x01))
#define JL_LEDC0                        ((JL_LEDC_TypeDef      *)JL_LEDC0_BASE)
#define JL_LEDC1_BASE                   (ls_base + map_adr(0x26, 0x09))
