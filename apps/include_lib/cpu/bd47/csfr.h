...
typedef struct {
    __RW __u32 CON[15]; // 0-3 used in bd47
    __RO __u32 REV0;
    __RW __u32 CID[15]; // 0-3 used in bd47
    __RO __u32 REV1;
    __RW __u32 BEG[15]; // 0-3 used in bd47
    __RO __u32 REV2;
    __RW __u32 END[15]; // 0-3 used in bd47
    __RW __u32 WREN;
} JL_MPU_TypeDef;
...
#define q32small_dcu_base    (q32small_sfr_base + 0x0500)
...
//#define q32small_dcu(n)      ((JL_TypeDef_q32small_DCU *)(q32small_dcu_base + q32small_sfr_offset*n))
...
typedef struct {
    ...
    /* 29 */  __RW __u32 BP6;
    /* 2a */  __RW __u32 BP7;
    /*    */  __RO __u32 REV_30_26[0x30 - 0x2a - 1];
