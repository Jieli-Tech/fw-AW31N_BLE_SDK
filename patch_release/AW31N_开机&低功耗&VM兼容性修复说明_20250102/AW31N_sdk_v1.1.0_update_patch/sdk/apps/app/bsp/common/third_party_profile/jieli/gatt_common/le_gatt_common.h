...
typedef struct {
    ...
    //config
    const gatt_server_cfg_t *server_config; /*gatt server 配置*/
    const gatt_client_cfg_t *client_config; /*gatt client 配置*/
    const sm_cfg_t *sm_config; /**/
...
void ble_gatt_client_set_search_config(const gatt_search_cfg_t *gatt_search_cfg);
